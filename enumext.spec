...
passthru: /* Reuse tokens from ARB_compute_shader */
	...
	use ARB_compute_shader			    UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER
	use ARB_compute_shader			    ATOMIC_COUNTER_BUFFER_REFERENCED_BY_COMPUTE_SHAD
...
ARB_compute_shader enum:
	...
	UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER	= 0x90EC
