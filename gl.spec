...
#    void GetPerfMonitorGroupStringAMD(uint group, sizei bufSize, sizei *length, char *groupString)
#    void GetPerfMonitorCounterStringAMD(uint group, uint counter, sizei bufSize, sizei *length, char *counterString)
...
#    void SelectPerfMonitorCountersAMD(uint monitor, boolean enable, uint group, int numCounters,
#    void BeginPerfMonitorAMD(uint monitor)
#    void EndPerfMonitorAMD(uint monitor)
#    void GetPerfMonitorCounterDataAMD(uint monitor, enum pname, sizei dataSize, uint *data, int *bytesWritten)
